var Boids3D = (function () {
    function Boids3D(renderer) {
        this.translateArray = [];
    ...
    Boids3D.prototype.initComputeRenderer = function () {
    ...
    Boids3D.prototype.initPosition = function () {
        ...
        this.particleUniforms = {
            ...
            invMatrix: { value: m.getInverse(this.camera.projectionMatrix) }
        };
        ...
        console.log(document.getElementById('vshader_billboard').textContent);
        this.mesh = new THREE.Mesh(this.geometry, this.material);
        this.scene.add(this.mesh);
    };
    Boids3D.prototype.fillTextures = function (texturePosition, textureVelocity) {
    ...
    Boids3D.prototype.getCameraConstant = function (camera) {
        return window.innerHeight / (Math.tan(THREE.Math.DEG2RAD * 0.5 * camera.fov) / camera.zoom);
    };
    Boids3D.prototype.createScene = function () {
    ...
    Boids3D.prototype.click = function () {
    };
    Boids3D.prototype.keyDown = function () {
    };
    Boids3D.prototype.update = function () {
