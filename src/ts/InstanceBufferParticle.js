var InstanceBufferParticle = (function () {
    function InstanceBufferParticle(renderer) {
        this.timer = 0;
        this.UPDATE = true;
        this.END = false;
    ...
    InstanceBufferParticle.prototype.remove = function () {
    ...
    InstanceBufferParticle.prototype.createScene = function () {
    ...
    InstanceBufferParticle.prototype.endEnabled = function () {
        this.UPDATE = false;
    };
    InstanceBufferParticle.prototype.update = function () {
    ...
    return InstanceBufferParticle;
}());
//# sourceMappingURL=InstanceBufferParticle.js.map