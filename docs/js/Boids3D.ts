...
class Boids3D{
    ...
    private initPosition() {
        ...
        //this.geometry.addAttribute('invMatrix', m.getInverse( this.camera.projectionMatrix ));
    ...
    public update() {
        ...
        // this.particleUniforms.invMatrix.value = this.camera.projectionMatrix.getInverse(this.camera.projectionMatrix);
